                        ...
                        lpPair && (
                            <>
                                <img
                                    loading="lazy"
                                    width="40"
                                    src={lpPair.key0.image}
                                    alt={`Flag of ${lpPair.key0.label}`}
                                    style={{ display: 'inline-flex', paddingRight: '8px' }}
                                ></img>
                                <span style={{ color: '#fff' }}>Pooled {lpPair.key0.label}</span>
                            </>
                        )
                    }
                </Box>
                        ...
                        lpPair && (
                            <>
                                <img
                                    loading="lazy"
                                    width="40"
                                    src={lpPair.key1.image}
                                    alt={`Flag of ${lpPair.key1.label}`}
                                    style={{ display: 'inline-flex', paddingRight: '8px' }}
                                ></img>
                                <span style={{ color: '#fff' }}>Pooled {lpPair.key1.label}</span>
                            </>
                        )
                    }
                </Box>
