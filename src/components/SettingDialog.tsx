                        ...
                        <DialogContent>
                            <Stack direction="column">
                                ...
                                <Stack marginY={1} direction="row" alignItems="center">
                                    <SlippageButton onClick={() => changeSlippage('0.1')} sx={{
                                        backgroundColor: strSlippage === '0.1' ? '#2B0E79' : '#DBEAFF',
                                        color: strSlippage === '0.1' ? '#FFFFFF' : '#2B0E79'
                                    }}>
                                        0.1
                                    </SlippageButton>
                                    <SlippageButton onClick={() => changeSlippage('0.5')} sx={{
                                        backgroundColor: strSlippage === '0.5' ? '#2B0E79' : '#DBEAFF',
                                        color: strSlippage === '0.5' ? '#FFFFFF' : '#2B0E79'
                                    }}>
                                        0.5
                                    </SlippageButton>
